...
namespace SchoolManagementSystem.Controllers
{
    public class TimeTblTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var timeTblTables = db.TimeTblTables.Include(t => t.ClassSubjectTable).Include(t => t.ClassTable).Include(t => t.RoomTable).Include(t => t.SessionProgrameSubjectSettingTable).Include(t => t.StaffTable).Include(t => t.SubjectTable).Include(t => t.UserTable);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ClassSubjectID = new SelectList(db.ClassTables, "ClassID", "Name");
            ViewBag.Room_ID = new SelectList(db.RoomTables, "RoomID", "Title");
            ViewBag.ClassSubjectID = new SelectList(db.SessionProgrameSubjectSettingTables, "SessionProgrameSubjectSettingID", "Description");
        ...
        public ActionResult Create([Bind(Include = "TimeTableID,User_ID,Subject_ID,ClassSubjectID,StaffID,Room_ID,StartTime,EndTime,Day,IsActive")] TimeTblTable timeTblTable)
        {
            ...
            ViewBag.ClassSubjectID = new SelectList(db.ClassSubjectTables, "ClassSubjectID", "Title", timeTblTable.ClassSubjectID);
            ...
            ViewBag.ClassSubjectID = new SelectList(db.SessionProgrameSubjectSettingTables, "SessionProgrameSubjectSettingID", "Description", timeTblTable.ClassSubjectID);
